...
class InputTagsList extends StatefulWidget {
  InputTagsList(
      {@required this.tags,
      this.columns = 4,
      this.autofocus,
  ...
  @override
  _InputTagsListState createState() => _InputTagsListState();
}

class _InputTagsListState extends State<InputTagsList> {
  ...
  Widget _buildRowList() {
    return Container(
      height: _tags.length > 0 ? 45 : 0,
      child: ListView.builder(
        scrollDirection: Axis.horizontal,
        itemCount: _tags.length,
        itemBuilder: (BuildContext context, int index) {
          return _buildField(index: index, width: 100, last: false);
        },
      ),
    );
  }
